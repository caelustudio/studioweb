...
(function () {
  var DICT = {
    'Caelus Studio - 始于设计，忠于设计 | 创意设计工作室': ['Caelus Studio - 始於設計，忠於設計 | 創意設計工作室', 'Caelus Studio - Begin With Design, Believe In Design | Creative Design Studio'],
    '首页': ['首頁', 'Home'],
    '下载': ['下載', 'Download'],
    '联系': ['聯繫', 'Contact'],
    '始于设计，忠于设计。': ['始於設計，忠於設計。', 'Begin with design, believe in design.'],
    '下滑探索': ['下滑探索', 'Scroll to explore'],
    '一切皆由': ['一切皆由', 'Everything is built with '],
    '打造。': ['打造。', '.'],
    ...
    '专业、丰富的设计。': ['專業、豐富的設計。', 'Professional, versatile design.'],
    '我们有 2 年的设计经验，也创作出了许多作品，其中包括 XyangOS、StarOS、CaelusOS、星乐海集团账号服务。我们也懂得了：任何作品都值得反复深挖。': ['我們有 2 年的設計經驗，也創作了許多作品，其中包括 XyangOS、StarOS、CaelusOS、星樂海集團帳號服務。我們也懂得了：任何作品都值得反覆深挖。', 'With 2 years of design experience, we have created many works, including XyangOS, StarOS, CaelusOS and the Xinglehai Group account services. And we have learned that every work deserves to be refined over and over.'],
    '个作品': ['個作品', ' works'],
    '年设计经验': ['年設計經驗', ' years of design experience'],
    '创意': ['創意', 'Creativity'],
    '价值观': ['價值觀', 'Values'],
    '环保': ['環保', 'Environment'],
    '教育': ['教育', 'Education'],
    '隐私': ['隱私', 'Privacy'],
    'PPT 系统': ['PPT 系統', 'PPT Systems'],
    '文件库': ['文件庫', 'Files'],
    'CaelusOS 文件库': ['CaelusOS 文件庫', 'CaelusOS Files'],
    'Caelus Studio 文件库': ['Caelus Studio 文件庫', 'Caelus Studio Files'],
    'TreeOS 文件库': ['TreeOS 文件庫', 'TreeOS Files'],
    '友情链接': ['友情連結', 'Links'],
    '联系方式': ['聯繫方式', 'Contact'],
    '电子邮件': ['電子郵件', 'Email'],
    '哔哩哔哩': ['嗶哩嗶哩', 'Bilibili'],
